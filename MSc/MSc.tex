...
\qquad Celem pracy jest stworzenie œrodowiska pomiarowego do pomiaru czasu transmisji danych w sieciach komórkowych pod k¹tem zastosowania tych sieci w systemach pomiarowych. W tym celu nale¿a³o opracowaæ aplikacjê dla urz¹dzeñ z systemem Android, a tak¿e dedykowane dla niej serwery napisane w jêzyku Python. Serwery te umo¿liwiaj¹ komunikacjê z aplikacj¹ zainstalowan¹ na terminalu mobilnym z wykorzystaniem zapytañ HTTP jak i za pomoc¹ gniazd protoko³u TCP/IP.
...
\subsubsection{Pomiar nieruchomego terminala mobilnego (nadanie 200 pakietów, sieæ LTE)}
...
\subsubsection{Pomiar nieruchomego terminala mobilnego (nadanie 200 pakietów, sieæ WCDMA)}
...
\subsubsection{Pomiar nieruchomego terminala mobilnego (nadanie 200 pakietów, sieæ EDGE)}
