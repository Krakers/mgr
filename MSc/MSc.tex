...
\begin{figure}[!htbp]
	\centering
\includegraphics[scale=1,natwidth=634,natheight=778]{server_socket_source_code.png}
...
\subsection{Opis realizacji programowej transmisji poprzez protokó³ TCP/IP}
